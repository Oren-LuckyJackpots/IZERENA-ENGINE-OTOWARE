...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
        ...
        var imageBitmapData = Assets.getBitmapData(Paths.getLibraryPath('images/izerena_soundtray.png'));
		// var tmp:Bitmap = new Bitmap(new BitmapData(_width, 30, true, 0x7F000000));
        var tmp:Bitmap = new Bitmap(imageBitmapData);
		screenCenter();
		addChild(tmp);
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Paths.font('one.ttf'), 10, 0x00e5ff);
		...
		for (i in 0...10)
		{
            ...
            // var volumeBitmapData = Assets.getBitmapData(Paths.getLibraryPath('images/izerena_soundtray_volume_' + i + '.png'));
            // tmp = new Bitmap(volumeBitmapData);
			tmp.x = bx;
			tmp.y = by;
			addChild(tmp);
			_bars.push(tmp);
